...
const BRAND_WORDS = [
  'Shield', 'Pro', 'Plus', 'Prime', 'Nest', 'Assure', 'Care', 'Plan', 
  'Protect', 'Safe', 'Trust', 'Cover', 'Secure', 'Total', 'Guard', 
  'Edge', 'Smart', 'Zen', 'Max', 'Elite', 'Core', 'Hub', 'Base', 
  'Zone', 'Spot', 'Box', 'Lab', 'Works', 'Co', 'Group', 'Solutions',
  'Ace', 'Apex', 'Arc', 'Axis', 'Beam', 'Blaze', 'Bolt', 'Bond', 'Boost',
  'Bridge', 'Bright', 'Burst', 'Cast', 'Champ', 'Charm', 'Chase', 'Choice',
  'Circle', 'Clear', 'Click', 'Cloud', 'Code', 'Craft', 'Crest', 'Crown',
  'Cube', 'Dash', 'Deck', 'Deep', 'Dive', 'Dock', 'Dome', 'Drive', 'Drop',
  'Echo', 'Elite', 'Emerge', 'Emit', 'Era', 'Eve', 'Ever', 'Exact', 'Excel',
  'Fame', 'Fast', 'Firm', 'Flash', 'Flow', 'Focus', 'Force', 'Forge', 'Form',
  'Frame', 'Fresh', 'Front', 'Frost', 'Fuse', 'Gain', 'Gale', 'Gate', 'Gaze',
  'Gear', 'Gift', 'Glide', 'Glow', 'Gold', 'Grace', 'Grand', 'Graph', 'Grasp',
  'Grid', 'Grip', 'Grove', 'Grow', 'Guide', 'Halo', 'Harbor', 'Haven', 'Haze',
  'Hear', 'Heart', 'Heavy', 'Helix', 'Hero', 'High', 'Hill', 'Hint', 'Hive',
  'Hold', 'Hollow', 'Honor', 'Hope', 'Horn', 'Horse', 'Host', 'House', 'Hue',
  'Huge', 'Hull', 'Hunt', 'Idea', 'Idle', 'Image', 'Impact', 'Index', 'Ink',
  'Inn', 'Input', 'Insight', 'Intense', 'Intent', 'Inter', 'Into', 'Ion', 'Iron',
  'Isle', 'Item', 'Ivory', 'Jade', 'Jail', 'Jam', 'Jar', 'Jaw', 'Jazz',
  'Jet', 'Jewel', 'Join', 'Joint', 'Joke', 'Jolt', 'Jot', 'Joy', 'Judge',
  'Jug', 'Juice', 'Jump', 'Jungle', 'Junk', 'Jury', 'Just', 'Keen', 'Keep',
  'Key', 'Kick', 'Kid', 'Kill', 'Kind', 'King', 'Kiss', 'Kit', 'Kite',
  'Knee', 'Knew', 'Knife', 'Knight', 'Knit', 'Knob', 'Knock', 'Knot', 'Know',
  'Label', 'Lack', 'Ladder', 'Lady', 'Lake', 'Lamb', 'Lamp', 'Land', 'Lane',
  'Language', 'Lap', 'Large', 'Laser', 'Last', 'Late', 'Laugh', 'Launch', 'Law',
  'Lawn', 'Lay', 'Layer', 'Lazy', 'Lead', 'Leaf', 'League', 'Leak', 'Lean',
  'Leap', 'Learn', 'Lease', 'Least', 'Leather', 'Leave', 'Lecture', 'Left', 'Leg',
  'Legal', 'Legend', 'Lemon', 'Lend', 'Length', 'Lens', 'Lent', 'Less', 'Lesson',
  'Let', 'Letter', 'Level', 'Lever', 'Levy', 'Lewis', 'Liable', 'Liberal', 'Library',
  'License', 'Lid', 'Lie', 'Life', 'Lift', 'Light', 'Like', 'Limb', 'Limit',
  'Line', 'Link', 'Lion', 'Lip', 'Liquid', 'List', 'Listen', 'Liter', 'Little',
  'Live', 'Load', 'Loan', 'Lobby', 'Local', 'Lock', 'Lodge', 'Log', 'Logic',
  'Lone', 'Long', 'Look', 'Loop', 'Loose', 'Loot', 'Lord', 'Lose', 'Loss',
  'Lost', 'Lot', 'Loud', 'Lounge', 'Love', 'Low', 'Loyal', 'Luck', 'Luggage',
  'Lump', 'Lunch', 'Lung', 'Lure', 'Lurk', 'Lush', 'Lust', 'Luxury', 'Lying',
  'Machine', 'Mad', 'Made', 'Magic', 'Magnet', 'Maid', 'Mail', 'Main', 'Major',
  'Make', 'Maker', 'Male', 'Mall', 'Mammal', 'Man', 'Manage', 'Mango', 'Manifest',
  'Manner', 'Manufacturer', 'Many', 'Map', 'Marble', 'March', 'Margin', 'Marine', 'Mark',
  'Market', 'Marriage', 'Mask', 'Mass', 'Master', 'Match', 'Material', 'Math', 'Matrix',
  'Matter', 'Maximum', 'May', 'Maze', 'Meadow', 'Mean', 'Measure', 'Meat', 'Mechanic',
  ...
  'Mom', 'Moment', 'Monitor', 'Monkey', 'Monster', 'Month', 'Mood', 'Moon', 'Moral',
  'More', 'Morning', 'Moss', 'Mother', 'Motion', 'Motor', 'Mountain', 'Mouse', 'Move',
  'Movie', 'Mow', 'Much', 'Muffin', 'Mule', 'Multiply', 'Muscle', 'Museum', 'Mushroom',
  ...
  'Nurse', 'Nut', 'Oak', 'Obedient', 'Object', 'Oblige', 'Obscure', 'Observe', 'Obtain',
  ...
  'Orchard', 'Order', 'Ordinary', 'Organ', 'Orient', 'Original', 'Orphan', 'Oscar', 'Other',
  'Otter', 'Ouch', 'Ought', 'Ounce', 'Our', 'Ourself', 'Out', 'Outdoor', 'Outer',
  'Output', 'Outside', 'Outstanding', 'Oval', 'Oven', 'Over', 'Own', 'Owner', 'Ox',
  'Oxygen', 'Oyster', 'Ozone', 'Pact', 'Paddle', 'Page', 'Paid', 'Paint', 'Pair',
  'Palace', 'Palm', 'Panda', 'Panel', 'Panic', 'Panther', 'Paper', 'Parade', 'Parent',
  'Park', 'Parrot', 'Party', 'Pass', 'Patch', 'Path', 'Patient', 'Patrol', 'Pattern',
  'Pause', 'Pave', 'Payment', 'Peace', 'Peach', 'Peak', 'Peanut', 'Pear', 'Peasant',
  'Pelican', 'Pen', 'Penalty', 'Pencil', 'People', 'Pepper', 'Perfect', 'Permit', 'Person',
  'Pet', 'Phone', 'Photo', 'Phrase', 'Physical', 'Piano', 'Picnic', 'Picture', 'Piece',
  'Pig', 'Pigeon', 'Pill', 'Pilot', 'Pink', 'Pioneer', 'Pipe', 'Pistol', 'Pitch',
  'Pizza', 'Place', 'Plan', 'Planet', 'Plant', 'Plastic', 'Plate', 'Play', 'Playground',
  'Pleasant', 'Please', 'Pledge', 'Plenty', 'Plot', 'Plug', 'Plunge', 'Poem', 'Poet',
  'Point', 'Polar', 'Pole', 'Police', 'Pond', 'Pony', 'Pool', 'Poor', 'Popular',
  ...
  'Proud', 'Provide', 'Public', 'Pudding', 'Pull', 'Pulp', 'Pulse', 'Pumpkin', 'Punch',
  'Pupil', 'Puppy', 'Purchase', 'Purity', 'Purpose', 'Purse', 'Push', 'Put', 'Puzzle',
  'Pyramid', 'Quality', 'Quantum', 'Quarter', 'Question', 'Quick', 'Quiet', 'Quilt', 'Quit',
  ...
  'Rebuild', 'Recall', 'Receive', 'Recipe', 'Record', 'Recover', 'Recycle', 'Red', 'Reduce',
  'Reef', 'Refer', 'Refuse', 'Region', 'Regret', 'Regular', 'Reject', 'Relax', 'Release',
  'Relief', 'Relieve', 'Relish', 'Remain', 'Remember', 'Remind', 'Remove', 'Render', 'Renew',
  'Rent', 'Reopen', 'Repair', 'Repeat', 'Replace', 'Reply', 'Report', 'Require', 'Rescue',
  'Resemble', 'Resist', 'Resource', 'Respond', 'Result', 'Retire', 'Retreat', 'Return', 'Reunion',
  'Reveal', 'Review', 'Reward', 'Rhythm', 'Rib', 'Ribbon', 'Rice', 'Rich', 'Ride',
  'Ridge', 'Rifle', 'Right', 'Rigid', 'Ring', 'Riot', 'Rip', 'Ripe', 'Rise',
  'Risk', 'Rival', 'River', 'Road', 'Roast', 'Robot', 'Robust', 'Rocket', 'Rocky',
  'Rod', 'Roll', 'Roman', 'Romance', 'Roof', 'Rookie', 'Room', 'Root', 'Rope',
  'Rose', 'Rotate', 'Rough', 'Round', 'Route', 'Rover', 'Row', 'Royal', 'Rub',
  'Rubber', 'Rude', 'Rug', 'Rule', 'Run', 'Runway', 'Rural', 'Rush', 'Rust',
  'Ruthless', 'Sad', 'Saddle', 'Sadness', 'Safe', 'Sail', 'Salad', 'Salmon', 'Salon',
  ...
  'Segment', 'Select', 'Sell', 'Seminar', 'Senior', 'Sense', 'Sentence', 'Series', 'Serious',
  'Servant', 'Serve', 'Service', 'Session', 'Set', 'Setting', 'Setup', 'Seven', 'Shadow',
  'Shaft', 'Shallow', 'Share', 'Shed', 'Shell', 'Sheriff', 'Shield', 'Shift', 'Shine',
  'Ship', 'Shiver', 'Shock', 'Shoe', 'Shoot', 'Shop', 'Short', 'Shoulder', 'Shove',
  'Shovel', 'Show', 'Shrimp', 'Shrug', 'Shuffle', 'Shy', 'Sibling', 'Sick', 'Side',
  'Siege', 'Sight', 'Sign', 'Silent', 'Silk', 'Silly', 'Silver', 'Similar', 'Simple',
  'Since', 'Sing', 'Siren', 'Sister', 'Sit', 'Situation', 'Six', 'Size', 'Skate',
  'Sketch', 'Ski', 'Skill', 'Skin', 'Skirt', 'Skull', 'Sky', 'Slab', 'Slam',
  'Sleep', 'Slice', 'Slide', 'Slight', 'Slim', 'Slogan', 'Slot', 'Slow', 'Slush',
  ...
  'Stain', 'Stair', 'Stake', 'Stale', 'Stalk', 'Stall', 'Stamp', 'Stand', 'Start',
  'State', 'Stay', 'Steak', 'Steel', 'Stem', 'Step', 'Stere', 'Stick', 'Still',
  'Sting', 'Stir', 'Stock', 'Stomach', 'Stone', 'Stool', 'Story', 'Stove', 'Strategy',
  'Street', 'Strike', 'String', 'Strip', 'Stroke', 'Struggle', 'Student', 'Stuff', 'Stumble',
  'Style', 'Subject', 'Submit', 'Subway', 'Success', 'Such', 'Sudden', 'Suffer', 'Sugar',
  'Suggest', 'Suit', 'Summer', 'Sun', 'Sunny', 'Sunset', 'Super', 'Supply', 'Support',
  ...
  'Test', 'Text', 'Thank', 'That', 'Theme', 'Then', 'Theory', 'There', 'These',
  'Thick', 'Thin', 'Thing', 'Think', 'Third', 'Thirsty', 'Thirteen', 'Thirty', 'This',
  'Thong', 'Thorn', 'Those', 'Thought', 'Thousand', 'Thread', 'Threat', 'Three', 'Thrive',
  'Throw', 'Thumb', 'Thunder', 'Thursday', 'Thus', 'Tide', 'Tiger', 'Tight', 'Tilt',
  ...
  'Tube', 'Tuesday', 'Tuff', 'Tumble', 'Tuna', 'Tunnel', 'Turbo', 'Turf', 'Turn',
  'Turtle', 'Twelve', 'Twenty', 'Twice', 'Twin', 'Twist', 'Two', 'Type', 'Typical',
  'Ugly', 'Umbrella', 'Unable', 'Unaware', 'Uncle', 'Uncover', 'Under', 'Undo', 'Unfair',
  'Unfold', 'Unhappy', 'Uniform', 'Unique', 'Unit', 'Universe', 'Unknown', 'Unlock', 'Unlucky',
  'Unmask', 'Unnecessary', 'Unpack', 'Unreal', 'Unrest', 'Unsafe', 'Until', 'Unusual', 'Unveil',
  'Unwanted', 'Unwelcome', 'Unwell', 'Unwind', 'Unwrap', 'Up', 'Update', 'Upgrade', 'Uphold',
  'Upon', 'Upper', 'Upset', 'Urban', 'Urge', 'Urgent', 'Usage', 'Use', 'Used',
  'Useful', 'Useless', 'User', 'Usual', 'Utility', 'Vacant', 'Vacuum', 'Vague', 'Valid',
  'Valley', 'Valor', 'Valuable', 'Value', 'Valve', 'Van', 'Vanish', 'Vapor', 'Variable',
  'Variety', 'Various', 'Vast', 'Vault', 'Vehicle', 'Velocity', 'Vendor', 'Venture', 'Venue',
  'Verb', 'Verify', 'Version', 'Versus', 'Vertical', 'Very', 'Vessel', 'Veteran', 'Viable',
  'Vibrant', 'Vicious', 'Victory', 'Video', 'View', 'Village', 'Vintage', 'Violate', 'Violence',
  'Violent', 'Violet', 'Violin', 'Virtual', 'Virtue', 'Virus', 'Visa', 'Visit', 'Visual',
  'Vital', 'Vivid', 'Vocal', 'Voice', 'Void', 'Volcano', 'Volume', 'Volunteer', 'Vomit',
  'Vote', 'Voucher', 'Vow', 'Voyage', 'Vulnerable', 'Wad', 'Wage', 'Wagon', 'Wait',
  'Wake', 'Walk', 'Wall', 'Wallet', 'Wander', 'Want', 'War', 'Ward', 'Warm',
  'Warn', 'Warrant', 'Warrior', 'Wash', 'Wasp', 'Waste', 'Water', 'Wave', 'Way',
  'We', 'Weak', 'Wealth', 'Weapon', 'Wear', 'Weasel', 'Weather', 'Weave', 'Web',
  'Wedding', 'Wednesday', 'Weed', 'Week', 'Weird', 'Welcome', 'Weld', 'Well', 'West',
  'Wet', 'Whale', 'What', 'Wheat', 'Wheel', 'When', 'Where', 'Whip', 'Whisper',
  'Wide', 'Width', 'Wife', 'Wild', 'Will', 'Win', 'Window', 'Wine', 'Wing',
  'Wink', 'Winner', 'Winter', 'Wire', 'Wisdom', 'Wise', 'Wish', 'Witness', 'Wizard',
  'Wobble', 'Wolf', 'Woman', 'Wonder', 'Wood', 'Wool', 'Word', 'Work', 'World',
  'Worm', 'Worry', 'Worth', 'Would', 'Wound', 'Woven', 'Wrap', 'Wreck', 'Wrestle',
  'Wrist', 'Write', 'Wrong', 'Wrote', 'Yacht', 'Yak', 'Yam', 'Yard', 'Yarn',
  'Yawn', 'Year', 'Yellow', 'You', 'Young', 'Youth', 'Yummy', 'Zap', 'Zebra',
  'Zero', 'Zone', 'Zoo', 'Zoom'
];
...
const ACTION_WORDS = [
  ...
  'My', 'Mine', 'Your', 'Yours', 'Our', 'Ours', 'Their', 'Theirs', 'His', 'Her', 'Hers',
  'The', 'A', 'An', 'This', 'That', 'These', 'Those',
  // Action verbs
  'Get', 'Go', 'Try', 'Use', 'Buy', 'Find', 'Search', 'Look', 'See', 'View',
  'Take', 'Make', 'Create', 'Build', 'Start', 'Begin', 'Join', 'Sign', 'Register',
  'Call', 'Contact', 'Connect', 'Link', 'Share', 'Save', 'Store', 'Keep', 'Hold',
  // Quality descriptors
  'Best', 'Top', 'Prime', 'Elite', 'Super', 'Ultra', 'Mega', 'Max', 'Pro', 'Plus',
  'Premium', 'Gold', 'Platinum', 'Vip', 'Deluxe', 'Luxury', 'Exclusive', 'Select',
  'New', 'Next', 'Fresh', 'Modern', 'Smart', 'Fast', 'Quick', 'Easy', 'Simple',
  'Now', 'Today', 'Here', 'Online', 'Digital', 'Tech', 'Cloud', 'AI', 'Smart'
];
...
function generateDomainIdeas(keyword, tld, maxSuggestions = 250) {
  ...
  for (const brandWord1 of focusedBrandWords.slice(0, 40)) {
    ...
    for (const brandWord2 of focusedBrandWords.slice(0, 20)) {
      if (suggestions.size >= maxSuggestions) break;
      const domain = createThreePart(brandWord1.toLowerCase(), cleanKeyword, brandWord2.toLowerCase());
      if (domain) suggestions.add(domain);
    }
  }
  ...
  for (const actionWord of focusedActionWords.slice(0, 30)) { // Use more action words
    if (suggestions.size >= maxSuggestions) break;
    for (const brandWord of focusedBrandWords.slice(0, 40)) {
      if (suggestions.size >= maxSuggestions) break;
      const domain = createThreePart(actionWord.toLowerCase(), cleanKeyword, brandWord.toLowerCase());
      if (domain) suggestions.add(domain);
    }
  }
  ...
  for (const brandWord of focusedBrandWords.slice(0, 30)) {
    ...
    for (const actionWord of focusedActionWords.slice(0, 30)) { // Use more action words
      if (suggestions.size >= maxSuggestions) break;
      const domain = createThreePart(brandWord.toLowerCase(), cleanKeyword, actionWord.toLowerCase());
      if (domain) suggestions.add(domain);
    }
  }
  ...
  for (const actionWord1 of focusedActionWords.slice(0, 20)) {
    ...
    for (const actionWord2 of focusedActionWords.slice(0, 15)) {
      if (suggestions.size >= maxSuggestions) break;
      const domain = createThreePart(actionWord1.toLowerCase(), cleanKeyword, actionWord2.toLowerCase());
      if (domain) suggestions.add(domain);
    }
  }
  ...
  const variations = [
    ...
    `my${cleanKeyword}`, `mine${cleanKeyword}`, `your${cleanKeyword}`, `yours${cleanKeyword}`,
    `our${cleanKeyword}`, `ours${cleanKeyword}`, `their${cleanKeyword}`, `theirs${cleanKeyword}`,
    `his${cleanKeyword}`, `her${cleanKeyword}`, `hers${cleanKeyword}`,
    `the${cleanKeyword}`, `this${cleanKeyword}`, `that${cleanKeyword}`,
    // Action verbs
    `get${cleanKeyword}`, `go${cleanKeyword}`, `try${cleanKeyword}`, `use${cleanKeyword}`, `buy${cleanKeyword}`,
    `find${cleanKeyword}`, `search${cleanKeyword}`, `look${cleanKeyword}`, `see${cleanKeyword}`, `view${cleanKeyword}`,
    `take${cleanKeyword}`, `make${cleanKeyword}`, `create${cleanKeyword}`, `build${cleanKeyword}`, `start${cleanKeyword}`,
    `join${cleanKeyword}`, `sign${cleanKeyword}`, `register${cleanKeyword}`, `call${cleanKeyword}`, `contact${cleanKeyword}`,
    // Quality descriptors
    `best${cleanKeyword}`, `top${cleanKeyword}`, `prime${cleanKeyword}`, `elite${cleanKeyword}`,
    `super${cleanKeyword}`, `ultra${cleanKeyword}`, `mega${cleanKeyword}`, `max${cleanKeyword}`,
    `premium${cleanKeyword}`, `gold${cleanKeyword}`, `platinum${cleanKeyword}`, `vip${cleanKeyword}`,
    `new${cleanKeyword}`, `next${cleanKeyword}`, `fresh${cleanKeyword}`, `modern${cleanKeyword}`,
    `smart${cleanKeyword}`, `fast${cleanKeyword}`, `quick${cleanKeyword}`, `easy${cleanKeyword}`, `simple${cleanKeyword}`,
    // Suffix variations
    `${cleanKeyword}now`, `${cleanKeyword}pro`, `${cleanKeyword}plus`, `${cleanKeyword}hub`, `${cleanKeyword}co`,
    `${cleanKeyword}app`, `${cleanKeyword}net`, `${cleanKeyword}io`, `${cleanKeyword}tech`,
    `${cleanKeyword}ai`, `${cleanKeyword}cloud`, `${cleanKeyword}space`, `${cleanKeyword}zone`,
    `${cleanKeyword}best`, `${cleanKeyword}top`, `${cleanKeyword}prime`, `${cleanKeyword}elite`,
    `${cleanKeyword}super`, `${cleanKeyword}ultra`, `${cleanKeyword}mega`, `${cleanKeyword}max`,
    `${cleanKeyword}go`, `${cleanKeyword}try`, `${cleanKeyword}use`, `${cleanKeyword}buy`,
    `${cleanKeyword}online`, `${cleanKeyword}digital`, `${cleanKeyword}smart`, `${cleanKeyword}fast`,
    `${cleanKeyword}new`, `${cleanKeyword}next`, `${cleanKeyword}premium`, `${cleanKeyword}gold`
  ];
  ...
  const popularBrandWords = ['Pro', 'Plus', 'Prime', 'Elite', 'Max', 'Ultra', 'Super', 'Mega', 
                            'Shield', 'Guard', 'Safe', 'Secure', 'Trust', 'Care', 'Plan', 'Nest',
                            'Hub', 'Base', 'Zone', 'Spot', 'Box', 'Lab', 'Works', 'Co', 'Solutions'];
  ...
  console.log(`Generated ${result.length} domain suggestions (all include full keyword: "${keyword}")`);
  return result;
}
